	...
	Private Function GetVertexLine(ByVal aBodyModel As SourceMdlModel10, ByVal aVertexInfo As SourceMdlVertexInfo10, ByVal aTexture As SourceMdlTexture10) As String
		...
		Try
			...
			If aTexture.width = 1 OrElse aTexture.height = 1 Then
				...
				End If
			Else
				If AppSettings.Instance.DecompileUseNonValveUvConversionIsChecked Then
			...
			line += " "
			'line += aVertex.texCoordY.ToString("0.000000", AppConstants.InternalNumberFormat)
			line += (1 - texCoordY).ToString("0.000000", AppConstants.InternalNumberFormat)
		Catch ex As Exception
			line = "// " + line
		End Try
