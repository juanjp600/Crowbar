					...
					For modelIndex As Integer = 0 To aBodyPart.theVtxModels.Count - 1
						...
						If aVtxModel.theVtxModelLods IsNot Nothing Then
							...
							For lodIndex As Integer = 1 To Me.theVtxFileData.lodCount - 1
								...
								'If lodIndex = 0 Then
								'    If Not AppSettings.Instance.DecompileReferenceMeshSmdFileIsChecked Then
								'        Continue For
								'    End If
								'ElseIf lodIndex > 0 Then
								'    If Not AppSettings.Instance.DecompileLodMeshSmdFilesIsChecked Then
								'        Exit For
								'    End If
								'End If
	...
	Private Sub WriteCollisionModelOrCollisionJointsOptions()
		...
		For i As Integer = 0 To Me.thePhyFileData.theSourcePhyPhysCollisionModels.Count - 1
			...
			If aSourcePhysCollisionModel.theDragCoefficientIsValid Then
				...
				line += """ "
				line += aSourcePhysCollisionModel.theDragCoefficient.ToString("0.######", AppConstants.InternalNumberFormat)
				Me.theOutputFileStreamWriter.WriteLine(line)
			End If
			...
			If aSourcePhysCollisionModel.theRollingDragCoefficientIsValid Then
				...
				line += aSourcePhysCollisionModel.theName
				line += """ "
				line += aSourcePhysCollisionModel.theRollingDragCoefficient.ToString("0.######", AppConstants.InternalNumberFormat)
				Me.theOutputFileStreamWriter.WriteLine(line)
			End If
		...
		Try
			If Me.theMdlFileData.theBoneControllers IsNot Nothing Then
				...
				For i As Integer = 0 To Me.theMdlFileData.theBoneControllers.Count - 1
					...
					line += """ "
					line += boneController.type.ToString(AppConstants.InternalNumberFormat)
					line += " "
