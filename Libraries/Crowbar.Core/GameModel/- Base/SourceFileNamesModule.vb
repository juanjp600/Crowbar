...
Public Module SourceFileNamesModule

	Public ReadOnly SmdFileNames As List(Of String) = New List(Of String)()
	...
	Public Function CreateBodyGroupSmdFileName(ByVal givenBodyGroupSmdFileName As String, ByVal bodyPartIndex As Integer, ByVal modelIndex As Integer, ByVal lodIndex As Integer, ByVal modelName As String, ByVal bodyModelName As String, Optional ByVal extraUvChannelIndex As Integer = -1) As String
		...
		Else
			...
			If AppSettings.Instance.DecompilePrefixFileNamesWithModelNameIsChecked AndAlso Not bodyModelFileName.ToLower(AppConstants.InternalCultureInfo).StartsWith(modelName.ToLower(AppConstants.InternalCultureInfo)) Then
				bodyGroupSmdFileName += modelName + "_"
			End If
			bodyGroupSmdFileName += bodyModelFileNameWithoutExtension
			If lodIndex = 0 Then
	...
	Public Function GetAnimationSmdRelativePath(ByVal modelName As String) As String
		...
		path = ""
		If AppSettings.Instance.DecompileBoneAnimationPlaceInSubfolderIsChecked Then
			path = modelName + "_" + Paths.AnimsSubFolderName
		End If
	...
	Public Function CreateAnimationSmdRelativePathFileName(ByVal givenAnimationSmdRelativePathFileName As String, ByVal modelName As String, ByVal iAnimationName As String, Optional ByVal blendIndex As Integer = -2) As String
		...
		Else
			...
			If Not AppSettings.Instance.DecompileBoneAnimationPlaceInSubfolderIsChecked Then
	...
	Private Function GetUniqueSmdFileName(ByVal givenSmdFileName As String) As String
		...
		While SmdFileNames.Contains(smdFileName.ToLower(AppConstants.InternalCultureInfo))
			nameNumber += 1
			smdFileName = givenSmdFileName + "_" + nameNumber.ToString()
		End While

		SmdFileNames.Add(smdFileName.ToLower(AppConstants.InternalCultureInfo))
		Return smdFileName
	End Function
