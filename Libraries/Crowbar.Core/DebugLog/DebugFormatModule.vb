Module DebugFormatModule
	...
	Public Function FormatLongWithHexLine(ByVal name As String, ByVal value As Long) As String
		...
		line = name
		line += ": "
		line += value.ToString("N0", AppConstants.InternalNumberFormat)
		line += " (0x"
	...
	Public Function FormatSingleFloatLine(ByVal name As String, ByVal value As Single) As String
		...
		line = name
		line += ": "
		line += value.ToString("N6", AppConstants.InternalNumberFormat)
		Return line
	End Function
	...
	Public Function FormatVectorLine(ByVal name As String, ByVal x As Double, ByVal y As Double, ByVal z As Double) As String
		...
		line = name
		line += "[x,y,z]: ("
		line += x.ToString("N6", AppConstants.InternalNumberFormat)
		line += ", "
		line += y.ToString("N6", AppConstants.InternalNumberFormat)
		line += ", "
		line += z.ToString("N6", AppConstants.InternalNumberFormat)
		line += ")"
		Return line
	End Function
	...
	Public Function FormatVectorLine(ByVal name As String, ByVal value As SourceVector) As String
		...
		line = name
		line += "[x,y,z]: ("
		line += value.x.ToString("N6", AppConstants.InternalNumberFormat)
		line += ", "
		line += value.y.ToString("N6", AppConstants.InternalNumberFormat)
		line += ", "
		line += value.z.ToString("N6", AppConstants.InternalNumberFormat)
		line += ")"
		Return line
	End Function
	...
	Public Function FormatQuaternionLine(ByVal name As String, ByVal value As SourceQuaternion) As String
		...
		line += value.z.ToString("N6", AppConstants.InternalNumberFormat)
		line += ", "
		line += value.w.ToString("N6", AppConstants.InternalNumberFormat)
		line += ")"
		Return line
	End Function
