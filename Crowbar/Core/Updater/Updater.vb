...
#Region "Update"
	...
	Private Sub Decompress()
		Try
			Using archive As New SevenZipExtractor.ArchiveFile(Me.theLocalFileName)
				archive.Extract(".", True)
			End Using
		Catch ex As Exception
			Throw New System.Exception("Crowbar tried to decompress the file """ + Me.theLocalPathFileName + """ but an exception was thrown: " + ex.Message)
		End Try
	...
	Private Sub OpenNewVersion()
		Throw New CursedException("TODO: reimplement")
	End Sub
